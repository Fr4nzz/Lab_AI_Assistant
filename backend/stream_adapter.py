...
Converts LangGraph events to AI SDK v5 UI Message Stream Protocol format.
...
class StreamAdapter:
    """Converts LangGraph events to AI SDK v5 UI Message Stream Protocol"""
